...
export function Topbar({ businessName, activeModules }: { businessName: string; activeModules: string[] }) {
  return (
    <header className="flex h-16 items-center justify-between gap-3 border-b border-slate-200 bg-white/80 px-4 backdrop-blur-sm sm:px-6">
      <div className="flex min-w-0 items-center gap-2">
        <MobileNav businessName={businessName} activeModules={activeModules} />
        <Link
